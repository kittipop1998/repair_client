<template>
    <div>
        ...
        <div class="text-center">
            ...
            <v-btn rounded color="amber lighten-2" class="mr-1" dark @click="$router.push({name : 'Inform_M'})">แจ้งซ่อม</v-btn>
            <v-btn rounded color="purple lighten-2" class="mr-1" dark >รอการอนุมัติ</v-btn>
