    ...
    <div>
        ...
        <div class="d-flex justify-center" >
            <v-card width="800" elevation="0"
                ...
                <v-card class="mx-auto mx-auto purple lighten-5">
                    <v-card-text  >
                    ...
                    <v-card-text >
                        <div class="font-weight-black" >
                            <div>
                                ...
                                <p class="purple--text"><span class="black--text">ช่าง: </span>{{ repair.technician? repair.technician: ''}}</p>
                                ...
                                ></v-img>
                                <br>
                                <p><span class="black--text">ภาพหลังการซ่อมแซม:</span></p>
                                <v-img
